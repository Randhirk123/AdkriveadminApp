...
<title>AdKrive - Send Email To All Advertiser</title>
<!-- site favicon -->
<base
			...
			<div class="bodywrapper__inner">
				<div class="row align-items-center mb-30 justify-content-between">
					<div class="col-lg-6 col-sm-6">
						<h6 class="page-title">Send Email To All Advertiser</h6>
					</div>
					<div
				...
				<div class="row mb-none-30">
					<div class="col-xl-12">
						<div class="card">
							<form action="/advertiser/send-email" method="POST">
								...
								<div class="card-footer">
									<div class="form-row">
										<div class="form-group col-md-12 text-center">
											<button type="submit" class="btn btn-block btn--primary mr-2">Send
												Email</button>
										</div>
									</div>
								</div>
