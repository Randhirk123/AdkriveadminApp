...
<title>AdKrive - Advertiser Transaction Logs</title>
<!-- site favicon -->
<base
...
<body>
			...
			<div class="sidebar__inner">
				...
				<div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
					<ul class="sidebar__menu">
						...
						<li class="sidebar-menu-item active"><a href="/keywords"
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Advertiser Transaction Logs</h6>
    </div>
    <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part">
        
    <form action="/report/transaction/advertisers" method="GET" class="form-inline float-sm-right bg--white">
        <div class="input-group has_append">
            <input type="text" name="search" class="form-control" placeholder="TRX / Username" value="">
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <c:choose>
                            		...
                            		<c:when test="${empty advTxLog}">
                            				<td class="text-muted text-center" colspan="100%">No
														Advertiser Transaction History Found</td></c:when>
                            				<c:otherwise>
                            				
                            						<c:forEach items="${advTxLog}" var="element">
                            							
                            							
                            								<tr>
                                <td data-label="Date">${element.date}</td>
                                <td data-label="TRX" class="font-weight-bold">${element.trx}</td>
                                <td data-label="Username"><a href="/advertiser/details/${element.id}">${element.username}</a></td>
                                <td data-label="Amount" class="budget">
                                    <strong  class="text-success" > + ${element.amount} INR</strong>
                                </td>
                                <td data-label="Charge" class="budget">₹ ${element.charge} </td>
                                <td data-label="Post Balance">${element.post_balance} INR</td>
                                <td data-label="Detail">Added Balance Via Admin</td>
                            </tr>
                            						</c:forEach>
                            				</c:otherwise>
