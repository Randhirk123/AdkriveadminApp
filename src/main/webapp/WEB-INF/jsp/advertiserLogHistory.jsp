...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>AdKrive - Advertiser Login History</title>
    <base
...
<!-- navbar-wrapper end -->
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Advertiser Login History -${username}</h6>
    </div>
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <c:choose>
                        				...
                        				<c:when test="${empty advertiserLogHistory}">
                        					 <td class="text-muted text-center" colspan="100%">No Advertiser Login History</td>
                        				</c:when>
                        				
                        				<c:otherwise>
                        				
                        					<c:forEach items="${advertiserLogHistory}" var="element">
                            	
                            					<tr>
                            							
                            		<td data-label="Date">1 week ago</td>
                                    <td data-label="Username"><a href="/advertiser/details/${element.advertiser_id}">${element.username}</a></td>
                                    <td data-label="IP">
                                        <a href="/users/login/ipHistory/${element.user_ip}">
                                           ${element.user_ip}
                                        </a>
                                    </td>
