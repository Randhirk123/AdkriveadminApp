...
<head>
    ...
    <title>AdKrive - All Tickets</title>
    <!-- site favicon -->
    <base
...
<!-- navbar-wrapper end -->
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">ALL Tickets</h6>
    </div>
                ...
                <div class="table-responsive--sm table-responsive">
                    <table class="table table--light">
                        ...
                        <c:choose>
                        		...
                        		<c:otherwise>
                        		<c:forEach items="${allTicketList}" var="element">
                        			<tr>
                                		...
                                		<td data-label="Status">
                                             ...
                                             <c:if test="${element.status eq 1}">Answer</c:if>
                                             
                                             <c:if test="${element.status eq 0}">open</c:if>
                                             
                                             <c:if test="${element.status eq 2}">Reply</c:if>
                                             <c:if test="${element.status eq 3}">close</c:if>
