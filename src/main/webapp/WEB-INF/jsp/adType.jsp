        ...
        <ul class="navbar__action-list">
          ...
          <span class="navbar-user">
            <span class="navbar-user__thumb"><img
                    src="images/profile/617ed8a4eb19e1635702948.jpg"
                    alt="image"></span>
    ...
    <div class="row">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive--md  table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                            		<c:choose>
                            			<c:when test="${empty listAid}">
													<td class="text-muted text-center" colspan="100%">No
														Record found</td>
												</c:when>
                            			<c:otherwise>
                            				<c:forEach items="${listAid}" var="element">
                            				
                            							                        <tr>
                                    <td data-label="Ad Name" class="text--primary">${element.adName}</td>
                                    <td data-label="Ad Type"><span
                                            class="text--small badge font-weight-normal badge--warning">${element.type}</span>
                                    </td>
                                    <td data-label="Width"><span
                                            class="text--small badge font-weight-normal badge--dark">${element.width}</span>
                                    </td>
                                    <td data-label="Height"><span
                                            class="text--small badge font-weight-normal badge--dark">${element.height}</span>                                    </td>
                                    <td data-label="Ad Slug">${element.slug}</td>
                                    <td data-label="Status"><span
                                            class="text--small badge font-weight-normal badge--success">${element.status}</span>
                                    </td>
                                    <td data-label="Action">
                                        <button type="button" class="icon-btn btn--primary edit"
                                                data-name="${element.adName}"
                                                data-type="${element.type}"
                                                data-width="${element.width}"
                                                data-height="${element.height}"
                                                data-slug="${element.slug}"
                                                data-status="${element.status}"
                                                data-route="/advertise/update/type/${element.id}">
        ...
        <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form:form action="/advertise/add/type" modelAttribute="aidType" method="POST" enctype="multipart/form-data">
                    <div class="modal-content">
                        <div class="modal-header btn--primary">
                            <h5 class="modal-title text-white" id="exampleModalLabel">Add new Type</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="form-control-label  font-weight-bold">Width<span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-control-label  font-weight-bold">Height<span
                                            class="text-danger">*</span></label>
                                    <div class="form-group  input-group has_append">
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form:form action="" modelAttribute="aidType" method="POST" enctype="multipart/form-data">
                    <div class="modal-content">
                        <div class="modal-header btn--primary">
                            <h5 class="modal-title text-white" id="exampleModalLabel">Edit Type</h5>
                            <button type="button" class="close text-light" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="type" type="text"
                                               name="type" value="" required  readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="form-control-label  font-weight-bold">Width<span
                                            class="text-danger">*</span></label>
                                    <div class="form-group  input-group has_append">
                                        <input type="text" class="form-control"  placeholder="width" id="w"
                                ...
                                <div class="col-md-6">
                                    <label class="form-control-label  font-weight-bold">Height<span
                                            class="text-danger">*</span></label>
                                    <div class="form-group  input-group has_append">
                                        <input type="text" id="h" class="form-control"  placeholder="height"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-control-label  font-weight-bold">Slug<span
                                                class="text-danger">*</span></label>
                                        <input class="form-control" type="text"  placeholder="slug" id="s"
                            ...
                            <div class="form-group">
                                     ...
                                     <li
												...
												Status: <label class="switch"> <input
													type="checkbox" name="status" id="checkbox">
													<div class="slider round"></div>
											</label>
											</li>
										</div>
