...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>AdKrive - Publisher Login History</title>
    <base
...
<!-- navbar-wrapper end -->
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Publisher Login History -${username}</h6>
    </div>
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <c:choose>
                        				...
                        				<c:when test="${empty pubLogHistory}">
                        					 <td class="text-muted text-center" colspan="100%">No Publisher Login History</td>
                        				</c:when>
                        				
                        				<c:otherwise>
                        				
                        					<c:forEach items="${pubLogHistory}" var="element">
                            	
                            					<tr>
                            							
                            		<td data-label="Date">1 week ago</td>
                                    <td data-label="Username"><a href="/publisher/details/${element.publisher_id}">${element.username}</a></td>
                                    <td data-label="IP">
