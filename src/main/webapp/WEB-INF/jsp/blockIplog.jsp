...
<body>
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Blocked Ip Logs</h6>
    </div>
                            ...
                            <tbody>
                               ...
                               <c:choose>
                            			<c:when test="${empty blockList}">
                            			 <td class="text-muted text-center" colspan="100%">No Blocked logs</td>				
                            			</c:when>
                            			<c:otherwise>
                            				<c:forEach items="${blockList}" var="element">
                            					<tr>
               ...
               <span aria-hidden="true">&times;</span>
                    ...
                    <form action="" method="POST">
                        <input type="hidden" name="_token" value="ZVtTDC1ZymuHWMLwsdqftDZT8fMSA4ZsNKNA67Qa">                        <div class="modal-body text-center">
                            ...
                            <h4 class="text--secondary mb-15">Are You Sure Want to Un Block This Ip?</h4>
    
                        </div>
                    <div class="modal-footer justify-content-center">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">close</button>
                      <button type="submit"  class="btn btn--success del">Un Block</button>
                    </div>
