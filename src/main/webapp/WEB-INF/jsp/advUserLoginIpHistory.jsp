...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>AdKrive - Advertiser Ip History</title>
    <base
...
<!-- navbar-wrapper end -->
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Login By-  ${element.user_ip}</h6>
    </div>
                        ...
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                 <c:choose>
                        				...
                        				<c:when test="${empty advUserLoginIpHistory}">
                        					 <td class="text-muted text-center" colspan="100%">No Advertiser IP History</td>
                        				</c:when>
                        				
                        				<c:otherwise>
                        				
                        					<c:forEach items="${advUserLoginIpHistory}" var="element">
