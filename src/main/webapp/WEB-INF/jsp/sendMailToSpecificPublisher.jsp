...
<!-- navbar-wrapper end -->
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Send Email To: Advertiseadmin</h6>
    </div>
    <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part">
        ...
        <div class="col-xl-12">
            <div class="card">
                <form action="https://adjuction.in/admin/user/send-email/4/1" method="POST">
                    <input type="hidden" name="_token" value="FU7R9p4c02I9FA6HrmCacrIobG1gDqX2UjNjGK2Q">                    <div class="card-body">
                        <div class="form-row">
...
<script src="js/iziToast.min.js"></script>
            <!-- <script> 
            "use strict";
            iziToast.success({message:"Advertiseadmin will receive an email shortly.", position: "topRight"}); 
        </script> -->
