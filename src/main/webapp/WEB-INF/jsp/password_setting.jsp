        ...
        <div class="col-lg-9 col-md-9 mb-30">
            <div class="card">
                <div class="card-body">
                    ...
                    <form:form action="/password" modelAttribute="pass" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="F95K9ASES9zJAkxdtOkhIDTiMWt1hjmX11zuugHq">
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Password</label>
                            <div class="col-lg-9">

                                <form:input class="form-control" path="password" placeholder="Password" name="old_password"></form:input>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <form:input class="form-control" path="newPassword" type="password" placeholder="New Password" name="password"></form:input>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <form:input class="form-control" path="confPassword" type="password" placeholder="Confirm Password" name="password_confirmation"></form:input>
                            </div>
                        </div>
