...
<title>AdKrive - User Login History</title>
<!-- site favicon -->
<base
								...
								<div class="table-responsive--sm table-responsive">
									<table class="table table--light style--two">
										...
										<tbody>
											...
											<c:choose>
												<c:when test="${empty userLoginList}">
												...
												<c:otherwise>
													<c:forEach items="${userLoginList}" var="element">

														<tr>
															<td data-label="Date"><fmt:formatDate type = "both" 
															value = "${element.created_at}" pattern="d"/></td>
															
															<td data-label="Username"><a
																href="/publisher/details/${element.publisher_id}">${element.username}</a></td>

															<td data-label="IP"><a
																href="/users/login/ipHistory/${element.user_ip}">
																	${element.user_ip} </a></td>
															<td data-label="Location">${element.location}</td>
															<td data-label="Browser">${element.browser}</td>
															<td data-label="OS">${element.os}</td>
														</tr>
													</c:forEach>
