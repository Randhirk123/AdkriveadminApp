...
<head>
  ...
  <title>AdKrive - Approved Withdrawals</title>
    <!-- site favicon -->
    <base
...
<form
    action="/withdraw/approved/search"
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                        				...
                        				<c:when test="${empty approvedWithdrawList}">
                        					  <td class="text-muted text-center" colspan="100%">No withdrawal is approved</td>
                        				</c:when>
                        				
                        				<c:otherwise>
                        				
                        					<c:forEach items="${approvedWithdrawList}" var="element">
