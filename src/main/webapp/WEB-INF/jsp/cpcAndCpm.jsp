...
<head>
    ...
    <title>AdKrive - Cost per click &amp; Cost per impression</title>
    <!-- site favicon -->
    <base
        ...
        <ul class="navbar__action-list">
          ...
          <span class="navbar-user">
            <span class="navbar-user__thumb"><img
                    src="/profile/617ed8a4eb19e1635702948.jpg"
                    alt="image"></span>
...
<!-- navbar-wrapper end -->
    ...
    <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part">
        <a href="/advertise/all" class="btn btn--primary"><i class="las la-backward"></i> Go Back</a>
    </div>
</div>
            ...
            <div class="row mb-none-30">
                <div class="col-xl-6 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--1 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">₹ ${globalSetting.cpc} (INR)</span>
                            </div>
                ...
                <div class="col-xl-6 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--primary b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">₹  ${globalSetting.cpm} (INR)</span>
                            </div>
                            <div class="desciption">
        ...
        <form:form action="/advertise/cpc&cpm/update" method="POST" modelAttribute="globalSetting"
                        ...
                        <div class="card-body">
                            <h5 class="card-title mb-15 border-bottom pb-2">Update CPC & CPM</h5>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            <label class="form-control-label font-weight-bold">Cost Per Click</label>
                                            <input class="form-control" name="cpc" type="text" value="${globalSetting.cpc}">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            <label class="form-control-label font-weight-bold">Cost Per Impression<span class="text-danger">*</span></label>
                                            <input class="form-control" type="text" name="cpm" value="${globalSetting.cpm}">
                                        </div>
                                    </div>
                                </div>
                        </div>
