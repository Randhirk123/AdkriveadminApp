...
<script type="text/javascript">
	function update1() {
		if (document.getElementById('chk').checked) {
			...
			alert(document.getElementById('chk_0').value);
		}
			...
			<div class="sidebar__inner">
				...
				<div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
					<ul class="sidebar__menu">
						...
						<li class="sidebar-menu-item "><a
							href="https://adjuction.in/admin/keywords" class="nav-link">
							...
							<div class="card-body p-0">
								<div class="p-3 bg--white">
									...
									<div class="mt-15">
										...
										<span class="text--small">Joined At <strong>${publish.created_at}
												</strong></span>
									</div>
								</div>
							</div>
						...
						<div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
							<div class="card-body">
								...
								<ul class="list-group">
									...
									<li
										class="list-group-item d-flex justify-content-between align-items-center">
										Status<span class="font-weight-bold">${publish.status}</span></li>

									<li
										class="list-group-item d-flex justify-content-between align-items-center">
										Balance <span class="font-weight-bold"> 0 INR</span>
									</li>
								</ul>
							</div>
						</div>
