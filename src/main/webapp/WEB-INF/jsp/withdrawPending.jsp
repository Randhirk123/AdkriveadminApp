...
<head>
   ...
   <title>AdKrive - Pending Withdrawals</title>
    <!-- site favicon -->
    <base
...
<form
    action="/withdraw/pending/search"
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                        				...
                        				<c:when test="${empty pendingWithdrawList}">
                        					  <td class="text-muted text-center" colspan="100%">No withdrawal is pending</td>
                        				</c:when>
                        				
                        				<c:otherwise>
                        				
                        					<c:forEach items="${pendingWithdrawList}" var="element">
