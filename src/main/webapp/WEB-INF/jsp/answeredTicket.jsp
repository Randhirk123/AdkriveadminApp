...
<head>
   ...
   <title>AdKrive - Answered Tickets</title>
    <!-- site favicon -->
    <base
            ...
            <div class="card-body p-0">
                <div class="table-responsive--sm table-responsive">
                    <table class="table table--light">
                        ...
                        <tbody>
                        <c:choose>
                        		<c:when test="${empty answeredTicketList}">
                        		<td class="text-muted text-center" colspan="100%">No Answered Ticket found.</td>
                        		</c:when>
                        		<c:otherwise>
                        		<c:forEach items="${answeredTicketList}" var="element">
                        			<tr>
                                		<td data-label="Subject">
                                    		<a href="/tickets/view/${element.id}" class="font-weight-bold">${element.subject}</a>
                                		</td>

                                		<td data-label="Submitted By">
                                            <a href="/publisher/details/${element.publisher_id}">${element.name}</a> <small>(Publisher)</small>
                                        </td>
                                        
                                		<td data-label="Status">
                                             <span class="text--small badge font-weight-normal badge--success"><c:if test="${element.status eq  1}"></c:if>Answered</span>
                                        </td>
                                ...
                                <td data-label="Action">
                                    <a href="/tickets/view/${element.id}" class="icon-btn  ml-1" data-toggle="tooltip" title="" data-original-title="Details">
