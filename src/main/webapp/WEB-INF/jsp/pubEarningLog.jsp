...
<title>AdKrive - Publisher Earning Logs</title>
<!-- site favicon -->
<base
...
<!-- navbar-wrapper end -->
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Publisher Earning Logs</h6>
    </div>
    <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part">
        
        <div class="d-flex flex-wrap justify-content-end">
            <form action="/report/publishers/earning-logs" method="GET" class="form-inline float-sm-right bg--white ml-3 mb-2">
                <div class="input-group has_append">
                <input type="text" name="date" data-range="true" data-multiple-dates-separator=" - " data-language="en" class="datepicker-here form-control" data-position='bottom left' placeholder="search by dates">
            ...
            <form action="/report/publishers/earning-logs" method="GET" class="form-inline float-sm-right bg--white ml-3 mb-2">
                <div class="input-group has_append">
                    <input type="text" name="search" class="form-control" placeholder="Username" value="">
                    <div class="input-group-append">
                        <button class="btn btn--primary" type="submit"><i class="fa fa-search"></i></button>
                    </div>
                </div>
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                            		...
                            		<c:choose>
                            				<c:when test="${empty pLogList}">
                            					 <td class="text-center" colspan="12">No Earning Logs.</td>
                            				</c:when>
                            				
                            				<c:otherwise>
                            				
                            					<c:forEach items="${pLogList}" var="element">
