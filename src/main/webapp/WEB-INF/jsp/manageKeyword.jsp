									...
									<table class="table table--light style--two">
										...
										<tbody>
											...
											<c:choose>
												...
												<c:when test="${empty listKeword}">
													<td class="text-muted text-center" colspan="100%">No
														Keywords found</td>
												</c:when>
												<c:otherwise>
													<c:forEach items="${listKeword}" var="element">

														<tr>
															<td data-label="Date"><fmt:formatDate type = "both" value = "${element.created_at}" pattern="dd-MMM-yyyy"/></td>

															<td data-label="Keywords"><span
																class="badge badge--primary">${element.keywords}</span></td>
															<td data-label="Action">
																<button type="button" data-toggle="modal"
																	data-target="#editModal" class="icon-btn edit"
																	data-toggle="tooltip" title="edit"
																	data-keywords="${element.keywords}"
																	data-route="/update/keywords/${element.id}">
																	<i class="las la-edit text--shadow"></i>
																</button> <a href="javascript:void(0)"
																data-route="/remove/keywords/${element.id}"
																class="icon-btn btn--danger delete"
																data-toggle="tooltip" title=""
																data-original-title="remove"> <i
																	class="las la-trash text--shadow"></i>
															</a>
															</td>
														</tr>
...
keyword three"></form:textarea>
				...
				<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog"
					...
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							<button type="button" class="close ml-auto m-3"
	...
	<script>
		...
		$(function() {
			...
			$('.edit').on('click', function() {
				...
				$('#editModal').find('input[name=keywords]').val(keyword);
			})
		})
