...
<head>
   ...
   <title>AdKrive - Pending Tickets</title>
    <!-- site favicon -->
    <base
            ...
            <div class="card-body p-0">
                <div class="table-responsive--sm table-responsive">
                    <table class="table table--light">
                        ...
                        <tbody>
                        <c:choose>
                        		<c:when test="${empty pendingTicketList}">
                        		<td class="text-muted text-center" colspan="100%">No Pending Ticket found.</td>
                        		</c:when>
                        		<c:otherwise>
                        		<c:forEach items="${pendingTicketList}" var="element">
                        			<tr>
                                		...
                                		<td data-label="Status">
                                             <span class="text--small badge font-weight-normal badge--success"><c:if test="${element.status eq  2}"></c:if>Open</span>
                                        </td>
