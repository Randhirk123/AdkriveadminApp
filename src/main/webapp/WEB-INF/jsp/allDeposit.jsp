...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
   <title>AdKrive - Deposit History</title>
    <base
...
<!-- navbar-wrapper end -->
    ...
    <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part">
         ...
         <form action="/deposit/list/search" method="GET" class="form-inline float-sm-right bg--white">
                        ...
                        <tbody>
                        		<c:choose>
                        				...
                        				<c:when test="${empty depositList}">
                        					 <td class="text-muted text-center" colspan="100%">No  deposits.</td>
                        				</c:when>
                        				
                        				<c:otherwise>
                        				
                        					<c:forEach items="${depositList}" var="element">
