            ...
            <div class="card-body p-0">
                <div class="table-responsive--sm table-responsive">
                    <table class="table table--light">
                        ...
                        <tbody>
                        <c:choose>
                        		<c:when test="${empty closedTicketList}">
                        		<td class="text-muted text-center" colspan="100%">No Closed Ticket found.</td>
                        		</c:when>
                        		<c:otherwise>
                        		<c:forEach items="${closedTicketList}" var="element">
                        			<tr>
                                		...
                                		<td data-label="Status">
                                             <span class="text--small badge font-weight-normal badge--dark"><c:if test="${element.status eq  3}"></c:if>Closed</span>
                                        </td>
