...
<head>
   ...
   <title>AdKrive - Withdrawals Log</title>
    <!-- site favicon -->
    <base
...
<form
    action="https://adjuction.in/admin/withdraw/log/search"
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <c:choose>
                        				...
                        				<c:when test="${empty allWithdrawList}">
                        					   <td class="text-muted text-center" colspan="100%">No withdrawal history</td>
                        				</c:when>
                        				
                        				<c:otherwise>
                        				
                        					<c:forEach items="${allWithdrawList}" var="element">
