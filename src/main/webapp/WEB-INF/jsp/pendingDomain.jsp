...
<head>
   ...
   <title>AdKrive - Pending Domain</title>
    <!-- site favicon -->
    <base
...
<!-- navbar-wrapper end -->
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Pending Domain</h6>
    </div>
    <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part">
            <form action="/domain/search" method="GET" class="form-inline float-sm-right bg--white">
        <div class="input-group has_append">
            <input type="text" name="search" class="form-control" placeholder="Search by tracker"
                   value="">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive--md  table-responsive">
                        <table class="table table--light style--two">
                            <thead>
                            <tr>
                                <th scope="col">Publisher Username</th>
                                <th scope="col">Domain Name</th>
                                <th scope="col">Site Keywords</th>
                                <th scope="col">Domain Tracker</th>
                                <th scope="col">Check Domain</th>
                            ...
                            <c:choose>
                            	<c:when test="${empty pendingDomainList}">
                            	   <td class="text-muted text-center" colspan="100%">No data</td>
                            		
                            	</c:when>
                            	
                            	<c:otherwise>
                            	<c:forEach items="${pendingDomainList}" var="element">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header bg--primary">
                        <h5 class="modal-title text-white" id="exampleModalLabel">Keywords</h5>
                ...
                <div class="modal-content">
                    ...
                    <form action="" method="POST">
                        <div class="modal-body text-center">
                            <input type="hidden" name="_token" value="wXhmMAo0Wxm0B9qWjilr2dC8iWVqOj7FsF54iDal">                            <i class="las la-exclamation-circle text-danger f-size--100  mb-15"></i>
                            <h3 class="text--secondary mb-15">Are You Sure Want to Delete This?</h3>
                        </div>
