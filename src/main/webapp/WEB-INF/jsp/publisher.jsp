...
<title>AdKrive - All publishers</title>
<!-- site favicon -->
<base
...
<script>
  function showHide(){
   var actv="<c:out value='${active}'/>";
   var ban = "<c:out value='${banned}'/>";
   var uve = "<c:out value='${emailUnverified}'/>";
   var uvs = "<c:out value='${smsUnverified}'/>";

    if(ban=="banned" || uve=="emailUnverified" || uvs=="smsUnverified")
	{
    ...
    if(actv=="active")
    {
    	document.getElementById('change').innerHTML = 'All Active Publisher';
    }
    else if(ban=="banned")
    {
    	document.getElementById('change').innerHTML = 'All Banned Publisher';
    }
    
    else if(uve=="emailUnverified")
    {
    	document.getElementById('change').innerHTML = 'All Email Unverified Publisher';
    }
    else if(uvs=="smsUnverified")
    {
    	document.getElementById('change').innerHTML = 'All Sms Unverified publisher';
    }
  }
</script>
	<!-- page-wrapper start -->
			...
			<div class="sidebar__inner">
				...
				<div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
					<ul class="sidebar__menu">
							...
							<div class="sidebar-submenu sidebar-submenu__open ">
								<ul>
									...
									<li class="sidebar-menu-item active"><a
										href="/publisher/all" class="nav-link"> <i
											class="menu-icon las la-dot-circle"></i> <span
											class="menu-title">All Publisher</span>
									</a></li>
									<li class="sidebar-menu-item "><a
						...
						<li class="sidebar-menu-item "><a
							href="https://adjuction.in/admin/general-setting"
							class="nav-link"> <i class="menu-icon las la-life-ring"></i>
								<span class="menu-title">General Setting</span>
						</a></li>

						<li class="sidebar-menu-item "><a
							href="https://adjuction.in/admin/setting/logo-icon"
							class="nav-link"> <i class="menu-icon las la-images"></i> <span
								class="menu-title">Logo Icon Setting</span>
						</a></li>

						<li class="sidebar-menu-item "><a
							href="https://adjuction.in/admin/extensions" class="nav-link">
								<i class="menu-icon las la-cogs"></i> <span class="menu-title">Extensions</span>
						</a></li>

						<li class="sidebar-menu-item  "><a
							href="https://adjuction.in/admin/language" class="nav-link"
							data-default-url="https://adjuction.in/admin/language"> <i
								class="menu-icon las la-language"></i> <span class="menu-title">Language
							</span>
						</a></li>

						<li class="sidebar-menu-item "><a
							href="https://adjuction.in/admin/seo" class="nav-link"> <i
								class="menu-icon las la-globe"></i> <span class="menu-title">SEO
									Manager</span>
						</a></li>
						...
						<li class="sidebar-menu-item sidebar-dropdown"><a
							...
							<div class="sidebar-submenu  ">
								<ul>
									...
									<li class="sidebar-menu-item  "><a
										href="https://adjuction.in/admin/email-template/global"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
											<span class="menu-title">Global Template</span>
									</a></li>
									<li class="sidebar-menu-item  "><a
										href="https://adjuction.in/admin/email-template/index"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
											<span class="menu-title">Email Templates</span>
									</a></li>

									<li class="sidebar-menu-item  "><a
										href="https://adjuction.in/admin/email-template/setting"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
						...
						<li class="sidebar-menu-item sidebar-dropdown"><a
							...
							<div class="sidebar-submenu  ">
								<ul>
									<li class="sidebar-menu-item  "><a
										href="https://adjuction.in/admin/sms-template/global"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
											<span class="menu-title">API Setting</span>
									</a></li>
									<li class="sidebar-menu-item  "><a
										href="https://adjuction.in/admin/sms-template/index"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
						...
						<li class="sidebar-menu-item "><a
							href="https://adjuction.in/admin/frontend/templates"
							class="nav-link "> <i class="menu-icon la la-html5"></i> <span
								class="menu-title">Manage Templates</span>
						</a></li>

						<li class="sidebar-menu-item "><a
							href="https://adjuction.in/admin/frontend/manage-pages"
							class="nav-link "> <i class="menu-icon la la-list"></i> <span
								class="menu-title">Manage Pages</span>
						</a></li>

						<li class="sidebar-menu-item sidebar-dropdown"><a
							href="javascript:void(0)" class=""> <i
								class="menu-icon la la-html5"></i> <span class="menu-title">Manage
									Section</span>
						</a>
							<div class="sidebar-submenu  ">
								<ul>
									<li class="sidebar-menu-item   "><a
										href="https://adjuction.in/admin/frontend/frontend-sections/banner"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
											<span class="menu-title">Banner Section</span>
									</a></li>
									<li class="sidebar-menu-item   "><a
										href="https://adjuction.in/admin/frontend/frontend-sections/benefits"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
											<span class="menu-title">Benefits Section</span>
									</a></li>
									<li class="sidebar-menu-item   "><a
										href="https://adjuction.in/admin/frontend/frontend-sections/blog"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
											<span class="menu-title">Manage Blog</span>
									</a></li>
									<li class="sidebar-menu-item   "><a
										href="https://adjuction.in/admin/frontend/frontend-sections/brands"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
											<span class="menu-title">Brands Section</span>
									</a></li>
									<li class="sidebar-menu-item   "><a
										href="https://adjuction.in/admin/frontend/frontend-sections/breadcrumb"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
											<span class="menu-title">Breadcrumb</span>
									</a></li>
									<li class="sidebar-menu-item   "><a
										href="https://adjuction.in/admin/frontend/frontend-sections/contact"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
											<span class="menu-title">Contact Page</span>
									</a></li>
									<li class="sidebar-menu-item   "><a
										href="https://adjuction.in/admin/frontend/frontend-sections/features"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
											<span class="menu-title">Feature Section</span>
									</a></li>
									<li class="sidebar-menu-item   "><a
										href="https://adjuction.in/admin/frontend/frontend-sections/footer"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
											<span class="menu-title">Footer Section</span>
									</a></li>
									<li class="sidebar-menu-item   "><a
										href="https://adjuction.in/admin/frontend/frontend-sections/format"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
											<span class="menu-title">Advertise Format</span>
									</a></li>
									<li class="sidebar-menu-item   "><a
										href="https://adjuction.in/admin/frontend/frontend-sections/login"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
											<span class="menu-title">Login &amp; Reg. Image</span>
									</a></li>
									<li class="sidebar-menu-item   "><a
										href="https://adjuction.in/admin/frontend/frontend-sections/overview"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
											<span class="menu-title">Overview Section</span>
									</a></li>
									<li class="sidebar-menu-item   "><a
										href="https://adjuction.in/admin/frontend/frontend-sections/policy"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
											<span class="menu-title">Policy &amp; Terms</span>
									</a></li>
									<li class="sidebar-menu-item   "><a
										href="https://adjuction.in/admin/frontend/frontend-sections/testimonial"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
											<span class="menu-title">Testimonial Section</span>
									</a></li>
									<li class="sidebar-menu-item   "><a
										href="https://adjuction.in/admin/frontend/frontend-sections/whychooseUs"
										class="nav-link"> <i class="menu-icon las la-dot-circle"></i>
						...
						<button type="button" class="" data-toggle="dropdown"
							...
							<span class="navbar-user"> <span
								class="navbar-user__thumb"><img
									src="images/profile/617cd7f2b15be1635571698.jpg" alt="image"></span>
			...
			<div class="bodywrapper__inner">
				<div class="row align-items-center mb-30 justify-content-between">
					<div class="col-lg-6 col-sm-6">
						<h6 class="page-title" id="change">All publishers</h6>
					</div>
					<div
						class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part"
						id="hide">
						<form action="/publisher/search" method="GET"
									...
									<table class="table table--light style--two">
										...
										<tbody>
											...
											<!-- for all publisher  search only -->
											 ...
											 <c:if test="${search eq 'search'}">
												...
												<c:choose>
													...
													<c:otherwise>
														<c:forEach items="${searchList}" var="element">
															<tr>
																<td data-label="Name" class="text--primary">${element.name}</td>
																<td data-label="Email" class="text--primary">${element.email}</td>
																<td data-label="Username" class="text--primary">${element.username}</td>
																<td data-label="Phone" class="text--primary">${element.phone}</td>
																<td data-label="Status"><span
																	class="text--small badge font-weight-normal badge--success ">
																		<c:if test="${element.status eq 1}">active</c:if> <c:if
																			test="${element.status eq 0}">deactive</c:if>
																		<c:if test="${element.status eq 2}">banned</c:if>
																</span></td>

																<td data-label="Actions"><a
																	href="/publisher/details/${element.id}" class="icon-btn"
																	data-toggle="tooltip" title=""
																	data-original-title="Details"> <i
																		class="las la-desktop text--shadow"></i>
																</a></td>
															</tr>
														</c:forEach>
											...
											<c:if test="${all eq 'all'}">
												<c:choose>
													<c:when test="${empty listOfAllPublishers}">
														<td class="text-muted text-center" colspan="100%">No
															Publishers</td>
													</c:when>
													<c:otherwise>
														<c:forEach items="${listOfAllPublishers}" var="element">
															<tr>
																<td data-label="Name" class="text--primary">${element.name}</td>
																<td data-label="Email" class="text--primary">${element.email}</td>
																<td data-label="Username" class="text--primary">${element.username}</td>
																<td data-label="Phone" class="text--primary">${element.phone}</td>
																<td data-label="Status"><span
																	class="text--small badge font-weight-normal badge--success "><c:if
																			test="${element.status eq 1}">active</c:if> <c:if
																			test="${element.status eq 0}">deactive</c:if>
																		<c:if test="${element.status eq 2}">banned</c:if></span></td>
																<td data-label="Actions"><a
																	href="/publisher/details/${element.id}" class="icon-btn"
																	data-toggle="tooltip" title=""
																	data-original-title="Details"> <i
											...
											<c:if test="${active eq 'active'}">
												...
												<c:choose>
													<c:when test="${empty listOfAllActivePublishers}">
														<td class="text-muted text-center" colspan="100%">No
															Active Publishers</td>
													</c:when>
													<c:otherwise>
														<c:forEach items="${listOfAllActivePublishers}"
															var="element">
															<tr>
																<td data-label="Name" class="text--primary">${element.name}</td>
																<td data-label="Email" class="text--primary">${element.email}</td>
																...
																<td data-label="Status"><span
																	class="text--small badge font-weight-normal badge--success "><c:if
																			test="${element.status eq 1}">active</c:if></span></td>
																<td data-label="Actions"><a
																	href="/publisher/details/${element.id}" class="icon-btn"
																	data-toggle="tooltip" title=""
																	data-original-title="Details"> <i
											...
											<!-- ********************************* -->
											<!-- FOR ALL BANNED PUBLISHER -->

											<!-- ********************************* -->
											<c:if test="${banned eq 'banned'}">
												<script>showHide()</script>
												<c:choose>
													<c:when test="${empty listOfAllBannedPublishers}">
														<td class="text-muted text-center" colspan="100%">No
															Banned Publishers</td>
													</c:when>
													<c:otherwise>
														<c:forEach items="${listOfAllBannedPublishers}"
															var="element">
															<tr>
																<td data-label="Name" class="text--primary">${element.name}</td>
																<td data-label="Email" class="text--primary">${element.email}</td>
																...
																<td data-label="Status"><span
																	class="text--small badge font-weight-normal badge--success "><c:if
																			test="${element.status eq 2}">banned</c:if></span></td>
																<td data-label="Actions"><a
																	href="/publisher/details/${element.id}" class="icon-btn"
																	data-toggle="tooltip" title=""
																	data-original-title="Details"> <i
											...
											<!-- ********************************* -->
											<!-- FOR ALL Email Unverified PUBLISHER -->

											<!-- ********************************* -->

											<c:if test="${emailUnverified eq 'emailUnverified'}">
												<script>showHide()</script>
												<c:choose>
													<c:when test="${empty listOfAllEmailUnverifiedPublisher}">
														<td class="text-muted text-center" colspan="100%">No
															Email Unverified Publishers</td>
													</c:when>
													<c:otherwise>
														<c:forEach items="${listOfAllEmailUnverifiedPublisher}"
															var="element">
															<tr>
																<td data-label="Name" class="text--primary">${element.name}</td>
																<td data-label="Email" class="text--primary">${element.email}</td>
																...
																<td data-label="Status"><span
																	class="text--small badge font-weight-normal badge--success "><c:if
																			test="${element.status eq 1}">active</c:if>
																		<c:if test="${element.status eq 0}">deactive</c:if> <c:if
																			test="${element.status eq 2}">banned</c:if></span></td>
																<td data-label="Actions"><a
																	href="/publisher/details/${element.id}" class="icon-btn"
																	data-toggle="tooltip" title=""
											...
											<!-- ********************************* -->
											<!-- FOR ALL SMS Unverified PUBLISHER -->

											<!-- ********************************* -->


											<c:if test="${smsUnverified eq 'smsUnverified'}">
												<script>showHide()</script>
												<c:choose>
													<c:when test="${empty listOfAllSmsUnverifiedPublisher}">
														<td class="text-muted text-center" colspan="100%">No
															Sms Unverified Publishers</td>
													</c:when>
													<c:otherwise>
														<c:forEach items="${listOfAllSmsUnverifiedPublisher}"
															var="element">
															<tr>
																<td data-label="Name" class="text--primary">${element.name}</td>
																<td data-label="Email" class="text--primary">${element.email}</td>
																...
																<td data-label="Status"><span
																	class="text--small badge font-weight-normal badge--success "><c:if
																			test="${element.status eq 1}">active</c:if>
																		<c:if test="${element.status eq 0}">deactive</c:if>
																		<c:if test="${element.status eq 2}">banned</c:if></span></td>
																<td data-label="Actions"><a
																	href="/publisher/details/${element.id}" class="icon-btn"
																	data-toggle="tooltip" title=""
