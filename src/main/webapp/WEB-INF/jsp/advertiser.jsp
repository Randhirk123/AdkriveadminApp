...
<script>
  function showHide(){
   ...
   var uvs = "<c:out value='${smsUnverified}'/>";
    ...
    if(actv=="active")
    {
    	document.getElementById('change').innerHTML = 'All Active Advertiser';
    }
    else if(ban=="banned")
    {
    	document.getElementById('change').innerHTML = 'All Banned Advertiser';
    }
    
    else if(uve=="emailUnverified")
    {
    	document.getElementById('change').innerHTML = 'All Email Unverified Advertiser';
    }
    else if(uvs=="smsUnverified")
    {
    	document.getElementById('change').innerHTML = 'All Sms Unverified Advertiser';
    }
  }
</script>
	<!-- page-wrapper start -->
			...
			<div class="bodywrapper__inner">
				<div class="row align-items-center mb-30 justify-content-between">
					<div class="col-lg-6 col-sm-6">
						<h6 class="page-title" id="change">All Advertiser</h6>
					</div>
					<div
						class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part"
						id="hide">
						<form action="/advertiser/search" method="GET"
								...
								<div class="table-responsive--md  table-responsive">
									<table class="table table--light style--two">
										...
										<tbody>
											...
											<!-- for all Advertiser search only -->
														...
														<c:forEach items="${searchList}" var="element">
															<tr>
																...
																<td data-label="Actions"><a
																	href="/advertiser/details/${element.id}" class="icon-btn"
											...
											<c:if test="${all eq 'all'}">
												<c:choose>
													<c:when test="${empty listOfAllAdvertiser}">
														<td class="text-muted text-center" colspan="100%">No
															Advertiser</td>
													</c:when>
													<c:otherwise>
														<c:forEach items="${listOfAllAdvertiser}" var="element">
															<tr>
																<td data-label="Name" class="text--primary">${element.name}</td>
																<td data-label="Email" class="text--primary">${element.email}</td>
																<td data-label="Username" class="text--primary">${element.username}</td>
											...
											<c:if test="${active eq 'active'}">
												...
												<c:choose>
													<c:when test="${empty listOfAllActiveAdvertiser}">
														<td class="text-muted text-center" colspan="100%">No
															Active Advertisers</td>
													</c:when>
													<c:otherwise>
														<c:forEach items="${listOfAllActiveAdvertiser}"
															var="element">
															<tr>
																<td data-label="Name" class="text--primary">${element.name}</td>
																<td data-label="Email" class="text--primary">${element.email}</td>
											...
											<!-- ********************************* -->
											<!-- FOR ALL BANNED ADVERTISER -->

											<!-- ********************************* -->
											<c:if test="${banned eq 'banned'}">
												<script>showHide()</script>
												<c:choose>
													<c:when test="${empty listOfAllBannedAdvertiser}">
														<td class="text-muted text-center" colspan="100%">No
															Banned Advertisers</td>
													</c:when>
													<c:otherwise>
														<c:forEach items="${listOfAllBannedAdvertiser}"
															var="element">
															<tr>
																<td data-label="Name" class="text--primary">${element.name}</td>
																<td data-label="Email" class="text--primary">${element.email}</td>
											...
											<!-- ********************************* -->
											<!-- FOR ALL Email Unverified ADVERTISER -->
											...
											<c:if test="${emailUnverified eq 'emailUnverified'}">
												<script>showHide()</script>
												<c:choose>
													<c:when test="${empty listOfAllEmailUnverifiedAdvertiser}">
														<td class="text-muted text-center" colspan="100%">No
															Email Unverified Advertisers</td>
													</c:when>
													<c:otherwise>
														<c:forEach items="${listOfAllEmailUnverifiedAdvertiser}"
															var="element">
															<tr>
																<td data-label="Name" class="text--primary">${element.name}</td>
																<td data-label="Email" class="text--primary">${element.email}</td>
											...
											<!-- ********************************* -->
											<!-- FOR ALL SMS Unverified ADVERTISER -->
											...
											<c:if test="${smsUnverified eq 'smsUnverified'}">
												<script>showHide()</script>
												<c:choose>
													<c:when test="${empty listOfAllSmsUnverifiedAdvertiser}">
														<td class="text-muted text-center" colspan="100%">No
															Sms Unverified Advertisers</td>
													</c:when>
													<c:otherwise>
														<c:forEach items="${listOfAllSmsUnverifiedAdvertiser}"
															var="element">
															<tr>
																<td data-label="Name" class="text--primary">${element.name}</td>
																<td data-label="Email" class="text--primary">${element.email}</td>
