                                    ...
                                    <div class="image-upload">
                                        <div class="thumb">
                                            ...
                                            <div class="avatar-edit">
                                                <input type="file"  name="file" id="profilePicUpload1" accept="image/png, image/jpg, image/jpeg" onchange="validateFileType()"/>
                                                <label for="profilePicUpload1" class="bg--success">Upload Image</label>
                                                <small class="mt-2 text-facebook">Supported files: <b>JPEG,PNG,JPG.</b> Image will be resized into 400x400px </small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
