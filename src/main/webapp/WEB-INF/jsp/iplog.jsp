...
<!-- navbar-wrapper end -->
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Advertise Ip Logs</h6>
    </div>
    <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part">
            <form action="" method="GET" class="form-inline float-sm-right bg--white">
        <div class="input-group has_append">
            <input type="text" name="search" class="form-control" placeholder="Ip" value="" autocomplete="off">
                            ...
                            <tbody>
                            		<c:choose>
                            			<c:when test="${empty ipList}">
                            			 <td class="text-muted text-center" colspan="100%">No logs</td>				
                            			</c:when>
                            			<c:otherwise>
                            				<c:forEach items="${ipList}" var="element">
                            					<tr>
                            					</tr>
                            				</c:forEach>
                            			</c:otherwise>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
               ...
               <span aria-hidden="true">&times;</span>
                    ...
                    <form:form action="" method="POST" modelAttribute="ipLog" >
                        <input type="hidden" name="_token" value="ZVtTDC1ZymuHWMLwsdqftDZT8fMSA4ZsNKNA67Qa">                        <div class="modal-body text-center">
                            
                            <i class="las la-exclamation-circle text-danger display-2 mb-15"></i>
                            <h4 class="text--secondary mb-15">Are You Sure Want to Block This Ip?</h4>
    
                        </div>
                    <div class="modal-footer justify-content-center">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">close</button>
                      <button type="submit"  class="btn btn-danger del">Block</button>
                    </div>
