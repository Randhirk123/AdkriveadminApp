...
<head>
    ...
    <title>AdKrive - Update Gateway : Perfect Money</title>
    <!-- site favicon -->
      <base
...
<!-- navbar-wrapper end -->
    ...
    <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part">
            <a href="/gateway/automatic" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="la la-fw fa-backward"></i>Go Back</a>
    </div>
</div>
                    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form:form action="/gateway/automatic/update/${pmnt.name}" method="POST" modelAttribute="pmnt"
                      enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="wXhmMAo0Wxm0B9qWjilr2dC8iWVqOj7FsF54iDal">                    <input type="hidden" name="alias" value="${pmnt.alias}">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="input-group d-flex flex-wrap justify-content-end has_append width-375">
                                            ...
                                            <div class="input-group-append">
                                                <button type="button" class="btn btn--primary newCurrencyBtn" data-crypto="${pmnt.crypto}" data-name="${pmnt.name}">Add new                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    <p></p>
    ...
    <div id="deleteModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="/gateway/automatic/remove/${id}" method="POST">
                    <input type="hidden" name="_token" value="wXhmMAo0Wxm0B9qWjilr2dC8iWVqOj7FsF54iDal">                    <input type="hidden" name="id">
