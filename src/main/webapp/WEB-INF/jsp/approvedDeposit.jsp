...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>AdKrive - Approved Deposits</title>
    <base
...
<!-- navbar-wrapper end -->
    ...
    <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part">
        ...
        <form action="/deposit/approved/search" method="GET" class="form-inline float-sm-right bg--white">
                        ...
                        <tbody>
                        		<c:choose>
                        				...
                        				<c:when test="${empty approvedList}">
                        					 <td class="text-muted text-center" colspan="100%">No Approved deposits.</td>
                        				</c:when>
                        				
                        				<c:otherwise>
                        				
                        					<c:forEach items="${approvedList}" var="element">
