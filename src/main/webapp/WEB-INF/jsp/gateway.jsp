...
<head>
    ...
    <title>AdKrive - Payment Gateways</title>
    <!-- site favicon -->
    <base
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two custom-data-table">
                            ...
                            <tr>
                                ...
                                <th scope="col">Supported Currency</th>
                                <th scope="col">Enabled Currency</th>
                            ...
                            <tbody>
                            			...
                            			<c:choose>
                            					...
                            					<c:when test="${empty gatewayList}">
                            							<td class="text-muted text-center" colspan="100%">No
															Record Found !!</td>
                            					</c:when>
                            					<c:otherwise>
                            							<c:forEach items="${gatewayList}" var="element">
                            									
                            									<tr>
                                    								<td data-label="Gateway">
                                        								<div class="user">
                                           							 <div class="thumb"><img src="https://adjuction.in/placeholder-image/800x800" alt="image"></div>
                                            							<span class="name">${element.name}</span>
                                        								</div>
                                   									 	</td>

														
                                    					<td data-label="Supported Currency">${fn:length(fn:split(element.supported_currencies, ','))}
                                    					</td>
                                    						<td data-label="Enabled Currency">
                                        						${element.crypto}
                                    						</td>
                                    						<td data-label="Status">
                                    						<span class="text--small badge font-weight-normal badge--success">${element.status}</span>
                                        
                                    						</td>
                                    						<td data-label="Action">
                                        						<a href="/gateway/automatic/edit/${element.name}" class="icon-btn editGatewayBtn" data-toggle="tooltip" title="" data-original-title="Edit">
                                            					<i class="la la-pencil"></i>
                                        						</a>
																	<button data-toggle="modal" data-target="#deactivateModal" class="icon-btn bg--danger ml-1 deactivateBtn" data-code="${element.code}" data-name="${element.name}" data-original-title="Disable">
    ...
    <div id="activateModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form:form action="/gateway/automatic/activate" modelAttribute="pmnt" method="POST">
                    <input type="hidden" name="_token" value="kyqxaml9hTQzOn989SNFZLJkQoqRcwjUkCjfRND9">
    ...
    <div id="deactivateModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form:form action="/gateway/automatic/deactivate" modelAttribute="pmnt" method="POST">
                    <input type="hidden" name="_token" value="kyqxaml9hTQzOn989SNFZLJkQoqRcwjUkCjfRND9">                    <input type="hidden" name="code">
                    <div class="modal-body">
