...
<body>
						...
						<button type="button" class="" data-toggle="dropdown"
							...
							<span class="navbar-user"> <span
								class="navbar-user__thumb"><img
									src="images/profile/617ed8a4eb19e1635702948.jpg" alt="image"></span>
				...
				<div class="row">
								...
								<div class="table-responsive--md  table-responsive">
									<table class="table table--light style--two">
										...
										<tbody>
											...
											<c:choose>
												<c:when test="${empty pricePlanList}">
												...
												<c:otherwise>
													<c:forEach items="${pricePlanList}" var="element">
														...
														<tr>
															...
															<td data-label="Price"><span
																class="badge  bg--primary">₹ ${element.price}</span></td>
															<td data-label="Type"><span
																class="text--small badge font-weight-normal badge--warning bg--">
																	<c:if test="${element.type eq 'Impression'}">Impression</c:if>
																	<c:if test="${element.type eq 'Click'}">
																		Click
																	</c:if>
															</span></td>
															<td data-label="Credit"><span
																class="badge badge-pill bg--secondary">${element.credit}</span>
															</td>
															<td data-label="Status">
																<script>showHideColor()</script>   
															<span
																class="text--small badge font-weight-normal badge--success">
																	<c:if test="${element.status eq 1}">Active</c:if>
															...
															<td data-label="Actions">
																<button type="button" class="icon-btn btn--primary edit"
																	...
																	data-type="${fn:toLowerCase(element.type)}"
																	data-credit="${element.credit}"
																	data-status="${element.status}"
																	data-route="/advertise/update/price-plan/${element.id}">
					...
					<div class="modal fade" id="addModal" tabindex="-1" role="dialog"
						...
						<div class="modal-dialog" role="document">
							<form:form action="/advertise/add/price-plan" method="POST"
								enctype="multipart/form-data" modelAttribute="priceplan">
								<div class="modal-content">
									...
									<div class="modal-body">
											...
											<div class="col-md-12">
												<div class="form-group ">
													<label class="form-control-label font-weight-bold">Name<span
														...
														placeholder="Plan name" type="text" name="name" value=""
														required>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<label class="form-control-label  font-weight-bold">Price<span
										...
										<div class="form-group">
											<li
												...
												Status: <label class="switch"> <input
													type="checkbox" name="status1" id="checkbox">
									...
									<div class="modal-body">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group ">
													<label class="form-control-label font-weight-bold">Name<span
														class="text-danger">*</span></label> <input class="form-control"
														placeholder="Plan name" type="text" name="name"
														value="${priceplan.name}" required>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												...
												<div class="form-group  input-group has_append">
													<input type="text" class="form-control" placeholder="Price"
														name="price" required value="${priceplan.price}">
													<div class="input-group-append">
											...
											<div class="col-md-12">
												<div class="form-group">
													<label class="form-control-label  font-weight-bold">Credit<span
														...
														value="${priceplan.credit}" required>
												</div>
											</div>
										</div>
	...
	<script>
		...
		$('.edit').on('click', function() {
			...
			if (status == 1) {
				modal.find('input[name=status1]').attr('checked', 'checked')
			}
