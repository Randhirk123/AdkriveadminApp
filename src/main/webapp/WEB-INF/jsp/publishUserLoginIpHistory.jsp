...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>AdKrive - Publisher Ip History</title>
    <base
                        ...
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                 <c:choose>
                        				...
                        				<c:when test="${empty pubLogIpHistory}">
                        					 <td class="text-muted text-center" colspan="100%">No Publisher IP History</td>
                        				</c:when>
                        				
                        				<c:otherwise>
                        				
                        					<c:forEach items="${pubLogIpHistory}" var="element">
