...
<head>
    ...
    <title>AdKrive - Withdraw Methods</title>
    <!-- site favicon -->
     <base
...
<!-- navbar-wrapper end -->
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Withdraw Methods</h6>
    </div>
    <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part">
            <a class="btn btn-sm btn--primary box--shadow1 text--small" href="/withdraw/method/create"><i class="fa fa-fw fa-plus"></i>Add New</a>
    </div>
</div>
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                            		...
                            		<c:choose>
                            				<c:when test="${empty listWithdrawMethod}">
                            					<td class="text-muted text-center" colspan="100%">No
														Withdraw Method available</td>
                            				</c:when>
                            				
                            				<c:otherwise>
                            				 
                            				 <c:forEach items="${listWithdrawMethod}" var="element">
                            				     	
                            				     	                        <tr>
                                    <td data-label="Method">
                                        <div class="user">
                                            <div class="thumb"><img src="data:image/jpeg;base64,${element.image}" alt="Card image cap"></div>
                                    ...
                                    <td data-label="Currency"
                                        class="font-weight-bold">${element.currency}</td>
                                    <td data-label="Charge"
                                        class="font-weight-bold">${element.fixed_charge} INR + ${element.percent_charge} %</td>
                                    <td data-label="Withdraw Limit"
                                        class="font-weight-bold">${element.min_limit} - ${element.max_limit}
                                         INR</td>
                                    <td data-label="Processing Time">${element.delay}</td>
                                    <td data-label="Status">
                                                                                    <span class="text--small badge font-weight-normal badge--success">Active</span>
                                                                            </td>
                                    <td data-label="Action">
                                        <a href="/withdraw/method/edit/${element.id}"
                                           class="icon-btn ml-1" data-toggle="tooltip" data-original-title="Edit"><i class="las la-pen"></i></a>
                                                                                    <a href="javascript:void(0)" class="icon-btn btn--danger deactivateBtn  ml-1" data-toggle="tooltip" data-original-title="Disable" data-id="1" data-name="${element.name}">
    ...
    <div id="activateModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="/withdraw/method/activate" method="POST">
                    <input type="hidden" name="_token" value="kCKIuQUDWqQ2FnqRj7aAqnGJts3gpBLtGT0JeRbn">                    <input type="hidden" name="id">
    ...
    <div id="deactivateModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="/withdraw/method/deactivate" method="POST">
                    <input type="hidden" name="_token" value="kCKIuQUDWqQ2FnqRj7aAqnGJts3gpBLtGT0JeRbn">                    <input type="hidden" name="id">
                    <div class="modal-body">
